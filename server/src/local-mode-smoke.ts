...
const fakePluginRuntime: BridgePluginRuntimeInfo = {
  ...
  sdkCapabilityDetails: {
    ...
    'plugin.richText.image': { supported: true, namespace: 'richText', api: 'image' },
    'plugin.richText.audio': { supported: true, namespace: 'richText', api: 'audio' },
    'plugin.richText.video': { supported: true, namespace: 'richText', api: 'video' },
  },
